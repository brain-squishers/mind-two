...
Download the checkpoints listed [here](#pre-trained-models) and put them under the `depth_anything_checkpoints` directory.
...
model.load_state_dict(torch.load(f'depth_anything_checkpoints/depth_anything_v2_{encoder}.pth', map_location='cpu'))
